...
describe('TitleService', () => {
  ...
  it('refreshTitle to be correct', () => {
    ...
    const mockTest = {
      titleSubscription: undefined as unknown as Subscription,
      titleSet: '',
      title: { setTitle: (title: string) => mockTest.titleSet = title },
      routerState: undefined,
      root: '',
      separator: '',
      getTitle: (routerState: undefined, root: string) => {
        mockTest.routerState = routerState;
        mockTest.root = root;
        return { join: (separator: string) => mockTest.separator = separator };
      },
      router: {
        events:
